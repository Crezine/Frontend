  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-white rounded-[32px] border border-secondary/10 shadow-sm p-6 md:p-10 mb-12">
        <h3 className="text-2xl font-bold text-secondary mb-8">Generate Payment Link</h3>
        <div className="space-y-6">
          <div>
            <label className="text-sm font-semibold text-secondary/80 mb-2 block">Client Name</label>
            <input 
              type="text" 
              placeholder="e.g. Acme Creative Agency"
              className="w-full py-4 px-5 border border-secondary/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
            />
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label className="text-sm font-semibold text-secondary/80 mb-2 block">Amount (USD)</label>
              <input 
                type="number" 
                placeholder="1500"
                className="w-full py-4 px-5 border border-secondary/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
            ...
            <div>
              <label className="text-sm font-semibold text-secondary/80 mb-2 block">Payment Type</label>
              <select className="w-full py-4 px-5 border border-secondary/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none bg-white font-medium">
          ...
          <div>
            <label className="text-sm font-semibold text-secondary/80 mb-2 block">What's this for?</label>
            <input 
              type="text" 
      ...
      <h3 className="text-xl font-bold text-secondary mb-6">Payment Link History</h3>
      <div className="space-y-4">
        {[1, 2].map(i => (
          <div key={i} className="flex flex-wrap items-center justify-between gap-4 p-5 bg-white rounded-2xl border border-secondary/10">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-secondary">Project #{4521 + i}</p>
                <p className="text-xs text-secondary/60">crezine.me/pay/creative-{i}23</p>
              </div>
            </div>
            <div className="text-right">
              <p className="font-bold text-secondary">$850.00</p>
